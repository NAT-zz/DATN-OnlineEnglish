...
import { saveTip } from '../../models/tips.model.js';
import tips from '../../models/tips.mongo.js';
...
const createTip = async (req, res) => {
    try {
        ...
        if (
            ...
            !data.content.every((val) => val.title && val.content)
        )
            return makeSuccessResponse(res, StatusCodes.BAD_REQUEST, {
...
export { getTipById, getAllTip, createTip, editTip, deleteTip };
