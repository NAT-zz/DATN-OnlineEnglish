...
export const StudentManagerPage = Loadable(
  lazy(() => import('../sections/@dashboard/ELstudent/StudentManager'))
);
export const StudentPostsPage = Loadable(
  lazy(() => import('../sections/@dashboard/ELstudent/StudentPostsPage'))
);
...
// English
export const QuestionPage = Loadable(lazy(() => import('../pages/dashboard/English/QuestionPage')));
export const QuestionListPage = Loadable(
  lazy(() => import('../pages/dashboard/English/QuestionListPage'))
);
export const TaskPage = Loadable(lazy(() => import('../pages/dashboard/English/TaskPage')));
export const TaskListPage = Loadable(lazy(() => import('../pages/dashboard/English/TaskListPage')));

export const LessonPage = Loadable(lazy(() => import('../pages/dashboard/English/LessonPage')));
export const LessonListPage = Loadable(
  lazy(() => import('../pages/dashboard/English/LessonListPage'))
);

export const ClassListPage = Loadable(
  lazy(() => import('../pages/dashboard/English/ClassListPage'))
);
export const ClassPage = Loadable(lazy(() => import('../pages/dashboard/English/ClassPage')));

export const TestListPage = Loadable(lazy(() => import('../pages/dashboard/English/TestListPage')));
export const TestPage = Loadable(lazy(() => import('../pages/dashboard/English/TestPage')));

export const DailyPage = Loadable(
  lazy(() => import('../pages/dashboard/EnglishStudent/DailyPage'))
);

export const LiveClassPage = Loadable(
  lazy(() => import('../pages/dashboard/EnglishStudent/LiveClassPage'))
);
export const AllClassPage = Loadable(
  lazy(() => import('../pages/dashboard/EnglishStudent/AllClassPage'))
);
export const MyClassPage = Loadable(
  lazy(() => import('../pages/dashboard/EnglishStudent/MyClassPage'))
);
export const ListTestPage = Loadable(
  lazy(() => import('../pages/dashboard/EnglishStudent/ListTestPage'))
);
export const ListLessionPage = Loadable(
  lazy(() => import('../pages/dashboard/EnglishStudent/ListLessionPage'))
);

export const ChatPage = Loadable(lazy(() => import('../pages/dashboard/ChatPage')));
export const ChatAIPage = Loadable(lazy(() => import('../pages/dashboard/ChatAIPage')));

export const DetailClassPage = Loadable(
  lazy(() => import('../pages/dashboard/EnglishStudent/DetailClassPage'))
);
export const DetailLessionPage = Loadable(
  lazy(() => import('../pages/dashboard/EnglishStudent/DetailLessionPage'))
);
export const DetailTestPage = Loadable(
  lazy(() => import('../pages/dashboard/EnglishStudent/DetailTestPage'))
);
